const HOTELS_PROMOTION_SETTINGS = [
	{
		name: "ОАЭ",
		hotels: [
			{
				...
				conditions: ["Акция не распространяется на даты: (29.11.2023 – 12.12.2023, 28.12.2023 – 02.01.2024)", "Акция распространяется на бронирование полных пакетных туров", "Не распространяется на групповые заявки от 15 человек", "Стоимость туров в поиске тура обозначена с учетом акции"],
		...
		hotels: [
			{
				...
				description: {
					...
					list: ["Корзина с фруктами и мини-бар (безалкогольные напитки) - 1 раз за весь период проживания", "Ранняя регистрация заезда (при наличии возможности в отеле)", "Поздняя регистрация отъезда (при наличии возможности в отеле)", "Неограниченный доступ в Восточный, Рыбный и Итальянский рестораны а ля карт (по предварительному заказу)", "Скидка 25% на СПА-услуги", "Cкидка 25% на услуги прачечной."]
				},
				conditions: ["Акция распространяется на бронирование полных пакетных туров.", "Акция не распространяется на кроме мастера нестандартного тура и групповые туры от 15 человек.", "Стоимость туров в поиске тура отображается с учетом акции."],
				booking: "с 15.11.2023 по 24.12.2023",
				accommodation: "с 13.12.2023 по 30.04.2024",
				departure_from: "Все",
				promotion_end: '24.12.2023',
				depth_days: 14
			},
			{
				...
				description: {
					text: "Акция от отеля «Черная Пятница»:",
					list: ["Корзина с фруктами и мини-бар (безалкогольные напитки) - 1 раз за весь период проживания", "Ранняя регистрация заезда (при наличии возможности в отеле)", "Поздняя регистрация отъезда (при наличии возможности в отеле)", "Неограниченный доступ в Восточный, Рыбный и Итальянский рестораны а ля карт (по предварительному заказу)", "Скидка 25% на СПА-услуги", "1 профессиональная фотография от фотографа отеля (по предварительной договоренности)", "Cкидка 25% на услуги прачечной."]
				},
				conditions: ["Акция распространяется на бронирование полных пакетных туров.", "Акция не распространяется на кроме мастера нестандартного тура и групповые туры от 15 человек.", "Стоимость туров в поиске тура отображается с учетом акции."],
				booking: "с 15.11.2023 по 24.12.2023",
				accommodation: "с 13.12.2023 по 30.04.2024",
			...
			},
			{
				...
				description: {
					text: "Акция от отеля «Черная Пятница»:",
					list: ["Раннее заселение (при наличии возможности в отеле)", "Неограниченный доступ в Восточный, Рыбный и Итальянский рестораны а ля карт (по предварительному заказу)", "Скидка 25% на СПА-услуги", "15% скидка на услуги прачечной"]
				},
				conditions: ["Акция распространяется на бронирование полных пакетных туров.", "Акция не распространяется на кроме мастера нестандартного тура и групповые туры от 15 человек.", "Стоимость туров в поиске тура отображается с учетом акции."],
				booking: "с 15.11.2023 по 24.12.2023",
				accommodation: "с 13.12.2023 по 30.04.2024",
			...
			},
			{
				...
				description: {
					...
					list: ["сауна (сухой пар) - 15 мин.", "джакузи - 15 мин.", "сауна (хамам) - 15 мин.", "скраб всего тела - 25 мин.", "кокосовая маска на все тело - 25 мин.", "массаж спины - 35 мин."]
				},
				conditions: ["Акция распространяется на бронирование полных пакетных туров.", "Акция не распространяется на кроме мастера нестандартного тура и групповые туры от 15 человек.", "Особые условия: Пакет СЕМЕЙНЫЙ 2+2=2 (тип номера Deluxe rooms, возраст детей до 11,99)", "Особые условия: пакет СПА-услуг (для всех типов номеров, на все резервации c 17.10.23)"],
				booking: "с 17.10.23",
		...
		hotels: [
			{
				...
				conditions: ["Акция не распространяется на даты: (01.01.2024-07.01.2024, 08.02.2024-18.02.2024, 29.03.2024-31.03.2024)", "Акция не распространяется на забронированные через Мастера нестандартного тура, и на групповые туры от 15 человек", "Стоимость туров в поиске тура обозначена с учетом акции"],
		...
		hotels: [
			{
				...
				conditions: ["Действительны для всех новых резерваций с 05.10.2022 по 30.11.2023", "Все типы номеров", "Акция распространяется на бронирование полных пакетных туров в режиме онлайн, кроме туров, забронированных в «Мастере нестандартного тура»", "Акция не распространяется на групповые туры более 15 человек", "Стоимость туров в поиске тура обозначена с учетом акции"],
